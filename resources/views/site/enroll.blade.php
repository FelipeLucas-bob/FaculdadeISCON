                        ...
                        <div class="col-lg-8 mx-auto">
                            <div class="enrollment-form-wrapper">
                                ...
                                <div class="enrollment-header text-center mb-5" data-aos="fade-up" data-aos-delay="200">
                                    ...
                                    <p>Preencha o formulário abaixo para garantir sua vaga em nosso processo seletivo.
                                    </p>
                                </div>
                                ...
                                <form class="enrollment-form needs-validation" id="enrollmentForm" data-aos="fade-up"
                                    data-aos-delay="300" action="{{ route('enroll.store') }}" method="POST" novalidate>
                                    @csrf
                                    @method('POST')
                                    <div class="row mb-4">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" name="name" class="form-control"
                                                    placeholder="Nome Completo..." minlength="3" required>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input type="email" id="email" name="email" class="form-control"
                                                    placeholder="exemplo@email.com.br" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="cpf" name="cpf" class="form-control"
                                                    maxlength="14" minlength="14" placeholder="000.000.000-00" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" id="whatsapp" name="whatsapp"
                                                    class="form-control" placeholder="(61) 99999-9999" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" id="telephone" name="telephone"
                                                    class="form-control" placeholder="(61) 3333-3333" required>
                                                <div class="invalid-feedback">Por favor, informe o telefone.</div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <select id="course" name="course" class="form-select" required>
                                                    ...
                                                    <option value="TecnologoGestaoHospitalar">Tecnólogo em Gestão
                                                        Hospitalar</option>
                                                </select>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="education" class="form-label">Nível de
                                                    Escolaridade</label>
                                                <select id="education" name="education" class="form-select" required>
                                                    <option value="">Selecione seu nível de escolaridade...
                                                    </option>
                                                ...
                                                <div class="invalid-feedback">Por favor, selecione o nível de
                                                    escolaridade.</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="motivation" class="form-label">O que te motiva a fazer
                                                    este curso?</label>
                                                <textarea id="motivation" name="motivation" class="form-control" rows="4"
                                                    placeholder="Compartilhe seus objetivos e o que espera alcançar..." required></textarea>
                                                ...
                                                <div class="schedule-options">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                            name="admission_type" id="vestibular"
                                                            value="Primeira Graduação (Vestibular)" required>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                            name="admission_type" id="segunda_graduacao"
                                                            value="Segunda Graduação" required>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                            name="admission_type" id="enem" value="ENEM"
                                                            required>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                            name="admission_type" id="transferencia"
                                                            value="Transferência" required>
                                                        <label class="form-check-label" for="transferencia">
                                                            Transferência
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="invalid-feedback">Por favor, selecione a forma de ingresso.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="agreement-section">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="terms" name="terms" required value="1">
                                                        <label class="form-check-label" for="terms">
                                                            Eu concordo com os <a href="#">Termos de Serviço</a>
                                                            e a <a href="#">Política de Privacidade</a> *
                                                        </label>
                                                        <div class="invalid-feedback">Você deve concordar com os
                                                            termos.</div>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                        ...
                                                        <label class="form-check-label" for="newsletter">
                                                            Gostaria de receber atualizações do curso e conteúdo
                                                            educacional por email
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-center">
                                            ...
                                            <p class="enrollment-note mt-3">
                                                ...
                                                Suas informações estão seguras e nunca serão compartilhadas com
                                                terceiros
                                            </p>
                                        </div>
                                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (typeof Inputmask !== 'undefined') {
          ...
          function applyPhoneMaskTelephone(input) {
                if (input) {
                    Inputmask({
                        mask: ['(99) 9999-9999'],
                        placeholder: '_',
            ...
            // Aplica a máscara em cada input
            applyPhoneMask(phoneInput);
            applyPhoneMaskTelephone(telephoneInput);
