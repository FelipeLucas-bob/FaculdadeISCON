...
<div class="container mt-5">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold text-primary mb-0">Atendimentos</h3>
        </div>
    </div>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        @php
                                            ...
                                            $badge = match ($status) {
                                                'pendente' => 'bg-warning',
                                                'concluído', 'concluido' => 'bg-success',
                                                'em andamento' => 'bg-info text-dark',
                                                'cancelado' => 'bg-danger',
                                                'em aberto' => 'bg-primary',
                                    ...
                                    <td class="text-center">
                                        <a href="#" class="btn btn-sm btn-none" title="Visualizar Atendimento">
                                            <i class="bi bi-eye h6"></i>
                                        </a>
                                        <a href="#" class="btn btn-sm btn-none" title="Conduzir Atendimento">
                                            <i class="bi bi-person-add h6"></i>
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
