...
<div class="container mt-5">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold text-primary mb-0">Tipos de Serviços</h3>
            <div class="d-flex justify-content-start">
                <button type="button" class="btn btn-primary me-2" data-bs-toggle="modal"
                    data-bs-target="#createServiceModal">   
                    <i class="bi bi-journal-plus"></i> Novo Serviço
                </button>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <table id="service-list" class="table style-1 dt-table-hover non-hover">
                        <thead class="mb-5">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                <td>
                                    @if($type->type == 1)
                                        <span class="badge bg-success">Atendimento</span>
                                    @else
                                        <span class="badge bg-info">Demanda</span>
                                    @endif
                                </td>
                                <td>{{ $type->sector_name }}</td>
...
{{-- Modal Novo Serviço --}}
@include('admin.services.modals.create-service')
