...
<div id="accordionCandidatos" class="accordion-icons accordion">
    ...
    <div class="card">
        ...
        <div id="collapseProva" class="collapse show" aria-labelledby="headingProva"
            ...
            <div class="card-body">
                <ul class="list-unstyled ps-2">
                    <li class="mb-2" style="font-size: 1rem;"><i class="bi bi-clock-history text-primary me-2"></i>
                        ...
                        assim que você clicar em "Iniciar Prova".</li>
                ...
                <form action="{{ route('registrations.proof') }}" method="POST" class="text-center mt-5">
                    @csrf
