...
<div class="container mt-5">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold text-primary mb-0">Candidatos</h3>
        </div>
    </div>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <div>
                                            ...
                                            {{-- <span class="badge bg-warning">Pendente de Pagamento</span>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('student.create') }}" class="btn btn-sm btn-none"
