...
<div class="container mt-5">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold text-primary mb-0">Alunos</h3>
        </div>
    </div>
                    ...
                    <table id="user-list" class="table style-1 dt-table-hover non-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="#" title="Emitir Contrato" class="me-1"><i class="bi bi-file-earmark-text"></i></a>
                                    <a href="#" title="Financeiro" class="me-1"><i class="bi bi-currency-dollar"></i></a>
                                    <a href="#" title="Matrícula" class="me-1"><i class="bi bi-person-check"></i></a>
