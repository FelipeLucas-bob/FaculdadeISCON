    ...
    <div class="container mt-5">
        ...
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3 class="fw-bold text-primary mb-0">Disciplinas</h3>
            </div>
        </div>
                            ...
                            <tbody>
                                @foreach ($disciplines as $discipline)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            @if ($discipline->level == 'Graduação')
                                                <span class="badge bg-primary">{{ $discipline->level }}</span>
                                            @else
                                                <span class="badge bg-info">{{ $discipline->level }}</span>
                                            @endif
                                        </td>
                                        <td class="text-center">
                                            <a href="#" class="btn btn-sm btn-none" title="Editar">
